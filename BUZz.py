...
source = 'ADD your own source' #  news source
News_API_KEY = ' your news api key ' # news api key
url = f'https://newsapi.org/v2/top-headlines?sources={source}&apiKey={News_API_KEY}'  
weather_api_key = "your Weather api key"# weather  API key
genai.configure(api_key="Your gemini api key")  #gemini api
...
def sendEmail(to, content):
    try:
        ...
        server.login('Your @gmail.com', 'Your gmail api key') # Login to the email account 
        server.sendmail('your @gmail.com', to, content) # Send the email
